        ...
        public static void Init(ICommons commons)
        {
            ...
            TranslationsRaw = new Dictionary<string, IDictionary<string, string>>()
            {
                ...
                ["zht"] = new Dictionary<string, string>()
                {
                    ...
                    ["Save"] = "儲存",
                    ["SaveAs"] = "另存為",
                    ["CopyLayoutToClipboard"] = "以JSON資料複製布局至剪貼簿",
                    ["LoadLayoutFromJson"] = "以JSON載入布局",
                    ["Exit"] = "離開",
                    ["Extras"] = "附加功能",
                    ["Normalize"] = "規格化",
                    ["ResetZoom"] = "重設縮放",
                    ["RegisterFileExtension"] = "註冊檔案副檔名",
                    ["RegisterFileExtensionSuccessful"] = "成功註冊檔案附檔名",
                    ["UnregisterFileExtension"] = "取消註冊檔按副檔名",
                    ["UnregisterFileExtensionSuccessful"] = "成功取消註冊檔案附檔名",
                    ["Successful"] = "成功",
                    ["Export"] = "匯出",
                    ["ExportImage"] = "匯出圖片",
                    ["UseCurrentZoomOnExportedImage"] = "在匯出的圖片使用當前縮放",
                    ["RenderSelectionHighlightsOnExportedImage"] = "在匯出的圖片上強調選中項目",
                    ["Language"] = "語言",
                    ["ManageStats"] = "管理統計資料",
                    ["ShowStats"] = "顯示土境資料",
                    ["BuildingCount"] = "建築數量",
                    ...
                    ["VersionCheckErrorMessage"] = "版本檢查錯誤訊息",
                    ["VersionCheckErrorTitle"] = "版本檢查錯誤標題",
                    ["EnableAutomaticUpdateCheck"] = "啟用自動更新檢查",
                    ["ContinueCheckingForUpdates"] = "繼續檢查更新",
                    ["ContinueCheckingForUpdatesTitle"] = "繼續檢查更新標題",
                    ["GoToProjectHomepage"] = "前往專案首頁",
                    ["OpenWelcomePage"] = "開啟歡迎頁面",
                    ["AboutAnnoDesigner"] = "關於 Anno Designer",
                    ["ShowGrid"] = "顯示網格",
                    ["ShowLabels"] = "顯示標籤",
                    ["ShowIcons"] = "顯示圖示",
                    ["ShowTrueInfluenceRange"] = "顯示實際影響範圍",
                    ["ShowInfluences"] = "顯示覆蓋影響範圍",
                    ["BuildingSettings"] = "建築設定",
                    ["Size"] = "大小",
                    ["Color"] = "顏色",
                    ["Label"] = "標籤",
                    ["Icon"] = "圖示",
                    ...
                    ["Both"] = "兩者",
                    ["PavedStreet"] = "鋪好的街道",
                    ["PavedStreetWarningTitle"] = "選中鋪好的街道",
                    ["PavedStreetToolTip"] = $"勾選此選項將變更建築物的影響範圍，{Environment.NewLine}表示使用鋪砌街道時建築物所接收的增加範圍。 {Environment.NewLine}使用「放置建築物」按鈕放置物件。",
                    ["Options"] = "選項",
                    ["EnableLabel"] = "啟用標籤",
                    ["Borderless"] = "無邊框",
                    ["Road"] = "道路",
                    ["PlaceBuilding"] = "放置建築",
                    ["Search"] = "搜尋",
                    ["SearchToolTip"] = "按ESC來清除搜尋內容",
                    ["SearchPlaceholder"] = "在這裡輸入建築物的名稱",
                    ["TitleAbout"] = "關於",
                    ["BuildingLayoutDesigner"] = "Ubisoft Anno 系列的一個建築佈局設計師",
                    ["Credits"] = "致謝",
                    ["OriginalApplicationBy"] = "原始套用",
                    ["BuildingPresets"] = "建築預製",
                    ["CombinedForAnnoVersions"] = "組合建築預置",
                    ["AdditionalChanges"] = "Github 上的貢獻者的額外變更",
                    ["ManyThanks"] = "非常感謝貢獻這個專案的所有用戶！",
                    ["VisitTheFandom"] = "請務必造訪 Anno 的 Fandom 頁面！ ",
                    ["OriginalHomepage"] = "原始首頁",
                    ["ProjectHomepage"] = "專案首頁",
                    ["GoToFandom"] = "前往 fandom",
                    ["Close"] = "關閉",
                    ["StatusBarControls"] = "滑鼠控制：左鍵 - 放置、選擇、移動 // 右鍵 - 停止放置、移除 // 雙鍵 - 全部移動 // 點兩下 - 複製 // 滾輪 - 縮放 // 滾輪點擊 - 旋轉。",
                    ["StatusBarItemsOnClipboard"] = "剪貼簿中的項目",
                    ["StatNothingPlaced"] = "沒任何放置",
                    ["StatBoundingBox"] = "邊框",
                    ["StatMinimumArea"] = "最小區域",
                    ["StatSpaceEfficiency"] = "空間利用率",
                    ["StatBuildings"] = "建築",
                    ["StatBuildingsSelected"] = "選中的建築",
                    ["StatTiles"] = "格",
                    ["StatNameNotFound"] = "找不到建築物名稱",
                    ["UnknownObject"] = "未知物件",
                    ["PresetsLoaded"] = "建築預製載入完",
                    ["ExportImageSuccessful"] = "圖片成功匯出。",
                    ["ExportImageError"] = "圖片匯出時發生錯誤。",
                    ["ApplyColorToSelection"] = "套用顏色",
                    ["ApplyColorToSelectionToolTip"] = "套用顏色於被當前選中的所有建築",
                    ["ApplyPredefinedColorToSelection"] = "套用預定義顏色",
                    ["ApplyPredefinedColorToSelectionToolTip"] = "套用預定義顏色（如果有）至所有選中的建築",
                    ["AvailableColors"] = "可用的顏色",
                    ["StandardColors"] = "預定義的顏色",
                    ["RecentColors"] = "最近使用的顏色",
                    ["Standard"] = "標準",
                    ["Advanced"] = "進階",
                    ["UpdateAvailableHeader"] = "有更新可用",
                    ["UpdateAvailablePresetMessage"] = $"發現有更新的預至檔案版本。{Environment.NewLine}是否要下載並且重啟應用程式？",
                    ["AdminRightsRequired"] = "需要管理員權限。",
                    ["UpdateRequiresAdminRightsMessage"] = "為了下載更新，應用程式需要寫入權限，請提供憑證。",
                    ["Error"] = "錯誤",
                    ["UpdateErrorPresetMessage"] = "安裝更新時出現錯誤。",
                    ["UpdateNoConnectionMessage"] = "無法建立網際網路連線。",
                    ["ColorsInLayout"] = "佈局中的顏色",
                    ["ColorsInLayoutToolTip"] = "按兩下顏色來選擇它",
                    ["LoadLayoutHeader"] = "載入佈局",
                    ["LoadLayoutMessage"] = "請在下方貼入 JSON 字串。",
                    ["ClipboardContainsLayoutAsJson"] = "剪貼簿包含當前 JSON 格式的佈局",
                    ["OK"] = "確定",
                    ["Cancel"] = "取消",
                    ["SelectAll"] = "全選",
                    ["Tools"] = "工具",
                    ["Preferences"] = "偏好設定",
                    ["ResetAllConfirmationMessage"] = "你確定要重置所有的熱鍵回預設？",
                    ["ResetAll"] = "全部重置",
                    ["UpdateSettings"] = "更新設定",
                    ["ManageKeybindings"] = "按鍵綁定",
                    ["Edit"] = "編輯",
                    ["Recording"] = "記錄",
                    ["RecordANewAction"] = "記錄新操作",
                    ["Rotate"] = "旋轉",
                    ["Copy"] = "複製",
                    ["Paste"] = "貼上",
                    ["Delete"] = "刪除",
                    ["Duplicate"] = "複製貼上",
                    ["RotateAll"] = "旋轉全部",
                    ["DeleteObjectUnderCursor"] = "刪除游標下的物件",
                    ["Licenses"] = "授權條款",
                    ["ViewLicenses"] = "查看開源授權條款",
                    ["ExternalLinkConfirmationMessage"] = "這將會在你的預設網頁瀏覽器開啟新頁籤，繼續？",
                    ["ExternalLinkMessageTitle"] = "開啟外部連結中",
                    ["RecentFiles"] = "最近使用的檔案",
                    ["UpdatePreferencesVersionInformation"] = "版本資訊",
                    ["UpdatePreferencesSettings"] = "設定",
                    ["UpdatePreferencesCheckPreRelease"] = "檢查預發布版本",
                    ["UpdatePreferencesUpdates"] = "更新",
                    ["UpdatePreferencesDownloadPresetsAndRestart"] = "下載預置並重啟應用程式",
                    ["UpdatePreferencesNewAppUpdateAvailable"] = "有心的可用更新！請檢察官往來得到更新公告。",
                    ["UpdatePreferencesNoUpdates"] = "當前已是最新版本。",
                    ["UpdatePreferencesErrorCheckingUpdates"] = "檢查更新時發生錯誤。",
                    ["UpdatePreferencesMoreInfoInLog"] = "日誌中發現了更多資訊。",
                    ["UpdatePreferencesNewPresetsUpdateAvailable"] = "有新的可用預置更新！",
                    ["UpdatePreferencesBusyCheckUpdates"] = "檢查更新中...",
                    ["UpdatePreferencesBusyDownloadPresets"] = "下載預置中...",
                    ["NoIcon"] = "無圖示",
                    ["GeneralSettings"] = "一般",
                    ["GeneralPreferencesUISettings"] = "UI 設定",
                    ["GeneralPreferencesHideInfluenceOnSelection"] = "隱藏選中的影響範圍",
                    ["GeneralPreferencesUseZoomToPoint"] = "使用新的縮放行為",
                    ["GeneralPreferencesGridLinesColor"] = "網格線顏色",
                    ["GeneralPreferencesObjectBorderLinesColor"] = "邊框顏色",
                    ["GeneralPreferencesZoomSensitivity"] = "縮放靈敏度",
                    ["GeneralPreferencesInvertScrollingDirection"] = "反轉滾動方向",
                    ["GeneralPreferencesInvertPanningDirection"] = "反轉平移方向",
                    ["GeneralPreferencesShowScrollbars"] = "顯示滾動條",
                    ["ColorTypeDefault"] = "預設",
                    ["ColorTypeLight"] = "燈光",
                    ["ColorTypeCustom"] = "自定義",
                    ["Warning"] = "警告",
                    ...
                    ["ItemsCopied"] = "項目已複製",
                    ["ItemCopied"] = "項目已複製",
                    ["LoadingPresetsFailed"] = "載入建築預置失敗。",
                    ["LoadingIconNamesFailed"] = "載入圖示名稱失敗。",
                    ["FileVersionUnsupportedMessage"] = $"是否仍嘗試載入？{Environment.NewLine}浙江很有可能失敗或導致奇怪的結果。",
                    ["FileVersionUnsupportedTitle"] = "檔案版本不支援",
                    ["IOErrorMessage"] = "儲存／載入檔案時發生錯誤。",
                    ["AnotherInstanceIsAlreadyRunning"] = "另一個此應用程式的實體已執行。",
                    ["ErrorUpgradingSettings"] = "設定檔案已損毀，我們必須重置你的設定。",
                    ["FileVersionMismatchMessage"] = $"是否仍嘗試載入？{Environment.NewLine}浙江很有可能失敗或導致奇怪的結果。",
                    ["FileVersionMismatchTItle"] = "檔案版本不相符",
                    ["LayoutLoadingError"] = "載入佈局時發生錯誤。",
                    ["LayoutSavingError"] = "儲存佈局時發生錯誤。",
                    ["InvalidBuildingConfiguration"] = "無效的建築配置。",
                    ["MergeRoads"] = "合併道路",
                    ["LoadingTreeLocalizationFailed"] = "載入語系失敗。",
                    ["Undo"] = "還原",
                    ["Redo"] = "重做",
                    ["LayoutSettings"] = "佈局設定",
                    ["View"] = "查看",
                    ["SaveUnsavedChanges"] = "儲存未保存的變更？",
                    ["UnsavedChanged"] = "有未保存的變更",
                    ["UnsavedChangedBeforeCrash"] = "程式崩潰，但有未保存的變更",
                    ["ColorPresetsVersion"] = "顏色預置版本",
                    ["TreeLocalizationVersion"] = "樹多語系版本",
                    ["ShowHarborBlockedArea"] = "顯示港口區域",
                    ["ShowPanorama"] = "顯示全景",
                    ["GeneralPreferencesRecentFilesSettings"] = "最近開啟的檔案",
                    ["GeneralPreferencesMaxRecentFiles"] = "最近使用的檔案最大數量",
                    ["Clear"] = "清除",
                    ["EnableDebugMode"] = "開啟除錯模式",
                    ["GeneralPreferencesIncludeRoadsInStatisticCalculation"] = "在統計中包含道路",
                    ["ShowMultipleInstanceWarning"] = "當有多個實例開啟時顯示警告",
                    ["WarningMultipleInstancesAreRunning"] = "有更新，但應用程式開啟多次，請關閉所有實例並只開啟一個來讓更新恢復正常。",
                    ["SelectAllSameIdentifier"] = "選擇同類型的所有建築",
                    ["RenderVersionOnExportedImage"] = "渲染版本於匯出圖片上"
                },
            };
